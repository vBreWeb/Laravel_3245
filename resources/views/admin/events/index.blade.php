...
font-black tracking-widest">
            ...
            <tbody class="divide-y border-t">
                ...
                <tr class="hover:bg-slate-50/50 transition">
                    ...
                    <td class="px-8 py-6">
                        <img src="{{ $event->poster_path ? asset('storage/' . $event->poster_path) : 'https://placehold.co/64x80' }}" class="w-16 h-20 rounded-xl object-cover shadow-sm" alt="Poster {{ $event->title }}">
                    </td>
                    <td class="px-8 py-6">
