...
$event->title) }}" class="w-full px-5 py-4 bg-slate-50 border-2 border-slate-100
...
$event->location) }}" class="w-full px-5 py-4 bg-slate-50 border-2
...
$event->price) }}" class="w-full px-5 py-4 bg-slate-50 border-2 border-slate-100
rounded-2xl focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-600
...
$event->stock) }}" class="w-full px-5 py-4 bg-slate-50 border-2 border-slate-100
rounded-2xl focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-600
